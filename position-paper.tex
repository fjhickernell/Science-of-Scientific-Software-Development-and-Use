...
\subsection{Large-scale computational environments}  Recognizing the increasing importance of computations in sciences and engineering,  the Illinois Institute of Technology, where the authors are,  established the College of Computing in June 2020, of which both the Departments of Applied Mathematics and Computer Science are integral parts, offering undergraduate and graduate degrees in not only applied/computational mathematics and computer science, but also cybersecurity, data science, artificial intelligence, and industrial technology. A significant portion of our faculty and graduate students have close collaborations with forefront computational scientists at the Argonne National Laboratory. As an ongoing effort, the Illinois Tech academic and research leadership have been holding meetings with industrial leaders including but not limited to Amazon and  Nvidia, in order to explore and create structures for democratizing cloud computing and parallel processing among scientific-computing members of Illinois Tech. Our multipronged approach aims to transform our next-generation scientists and engineers, who are well versed in software engineering principles in desktop environments, to adapt to diverse, emerging computing platforms.
