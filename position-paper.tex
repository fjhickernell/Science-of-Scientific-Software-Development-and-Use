...
This position paper focuses on four challenges: i) connectivity among software packages, ii) data-driven error estimates/bounds that propagate across algorithms, iii) taking advantage of evolving large-scale computational environment, and education of CSE developers and users.
